...
public class RequestControllerTest {
    ...
    void getUserRequestsTest() throws Exception {
        RequestDto requestDto = RequestDto.builder()
                ...
                .description("description")
                .build();
        when(service.getUserRequests(1L)).thenReturn(List.of(requestDto));
    ...
    void getRequestsTest() throws Exception {
        RequestDto requestDto = RequestDto.builder()
                ...
                .description("description")
                .build();
        when(service.getRequests(InfoFromRequest.getInfoFromRequest(1L, 0, 20))).thenReturn(List.of(requestDto));
